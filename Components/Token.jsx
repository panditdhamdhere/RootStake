          ...
          <div className="col-12">
            <div className="invest invest--big">
              ...
              <div className="row">
                ...
                <div className="col-12 col-lg-5 offset-lg-1">
                  <div className="invest__rate-wrap">
                    <div className="invest__rate">
                      <span>Total Stake</span>
                      <p className="green">1 PDT = 000001 tRBTC</p>
                    </div>
                    <div className="invest__graph">
              ...
              <p className="invest__info">
                ...
                Necessitatibus fugiat consectetur sint molestiae odit numquam
                ipsum voluptatum? Iure natus suscipit quam magni similique?
                Provident praesentium eum maxime, sit numquam ea!
              </p>
            </div>
          </div>
        </div>
